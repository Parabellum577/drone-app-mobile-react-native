...
const ServiceDetailsScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const handleSubmitBooking = async () => {
    ...
    try {
      ...
      const successMessage = service?.category === ServiceCategory.EVENT 
            ...
            {service.category && (
              <View style={styles.categoryContainer}>
                <View style={styles.categoryBadge}>
                  <Icon name={categoryIcons[service.category]} size={16} color={COLORS.primary} />
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            {service?.category === ServiceCategory.EVENT ? (
              <View style={styles.eventInfoContainer}>
                ...
                <Text style={styles.eventInfoDesc}>
                  You are registering for an event with the specified date and time.
                </Text>
              </View>
            ) : (
              <>
            ...
            <Text style={styles.modalLabel}>Additional Information (Optional)</Text>
            <TextInput
